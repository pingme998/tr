...
echo "$ehashone.$ehashtwo@incorporatedmail.com" >/var/www/html/dev.html
...
echo $SECUREKEY >>/var/www/html/dev.html
...
echo "mailid=$GETMAILID" >>/var/www/html/dev.html
...
python3 /$REPONAME/gen/run1.py >>/var/www/html/dev.html
...
python3 /$REPONAME/gen/run2.py >>/var/www/html/dev.html
pkill firefox
pkill geckodriver
